...
# On crée une nouvelle tâche qui se lancera au redémarrage avec votre session SNCF, cette tache installera les logiciels DOSEQUI, GENERICINSTALL, OCSSKYPE et Office standard
