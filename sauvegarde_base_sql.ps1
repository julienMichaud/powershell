### Objectif du script:  ###
### Créer des dumps de toutes les bdd présente sur le A8O pour les archiver sur le NAS S50CLRENAJY. Ces dump seront stockés dans des dossiers à leurs noms (exemple les dump de la bdd "glpi" seront dans le dossier "glpi")
